...
h3. Modified the following files:
* install.sh
* j2fly.zsh-theme
* templates/zshrc.zsh-template
* README
* custom/j2fly_shortcuts.zsh
...
@wget --no-check-certificate https://github.com/jaigouk/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
